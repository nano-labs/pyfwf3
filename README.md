...
4. [Usage](#usage)
    ...
    2. [Queryset](#queryset)
        * [.filter()](#filterkwargs)
        * [.exclude()](#excludekwargs)
        * [.order_by()](#order_byfield_name-reversefalse)
        * [.unique()](#uniquefield_name)
        * [.count()](#count)
        * [.values()](#valuesfields)
    3. [Models](#models)
        1. [BaseLineParser](#pyfwf3baselineparser)
            * [_before_parse()](#_before_parse)
            * [_after_parse()](#_after_parse)
        2. [BaseFileParser](#pyfwf3basefileparser)
            * [.open()](#openfilename-line_parsernone)
...
Lets take [this file](https://raw.githubusercontent.com/nano-labs/pyfwf3/master/examples/humans.txt) as example. Here its first line:
```
